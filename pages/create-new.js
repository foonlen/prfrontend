...
{   
    ...
    {   
        ...
        fetch(this.state.API_BASE_URL+"orders/create_new", {
            method:'POST',
            headers: headers,
              ...
              console.log(result)
                ...
                {   
                    ...
                    { 
                        ...
                        {
                            Router.push('/advertiser/orders/discussion/'+result.message.order_row_id)
                        }
                    }
                    else
                    {
...
{/* new design starts here */}
        <div className="create_campaign_form">
            ...
            <form id="myForm" className="services_form">
                <div className="row">
                    <div className="col-lg">
                        <div className="field auth__field select_platform">
                            ...
                            <div className="error_class">
                                {this.state.error_platform_row_id}
                            </div>
                        </div>
                    </div>
                ...
                <button className="btn btn-primary btn-block" type="button" onClick={()=>{this.addNewRequest()}}>Add New</button>
                </div>
              </div>
            </form>    
            </div>
            ...
            null
             ...
             <button type="button" className="cp-primary-btn mt-3 cp-btn" onClick={() => {this.saveOrderDetails()}} >
