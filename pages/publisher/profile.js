...
updateOtherData() 
{
    ...
    if (this.state.people_range_id == '') {
        this.setState({
            error_people_range_id: "The Price Range field is required."
        });
        formIsValid = false;
    }
    else {
    ...
    if (this.state.about_publisher == '') {
        this.setState({
            error_about_publisher: "The About Advertiser field is required."
        });
        formIsValid = false;
    }
    else if (this.state.about_publisher.length < 4) {
        this.setState({
            error_about_publisher: "The About Advertiser field must be at least 4 characters in length."
        });
        formIsValid = false;
    }
    else {
